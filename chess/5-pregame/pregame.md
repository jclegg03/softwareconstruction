...
To implement this, you will create a ServerFacade class to handle sending HTTP requests to and recieving responses from your server. Your client code will then use your ServerFacade methods to make server API calls.
